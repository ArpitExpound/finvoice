                      ...
                      <Tbody>
                            ...
                            return (
                              <Tr key={index} verticalAlign="top">
                                ...
                                <Td
                                  ...
                                  p={2}
                                >
                                  {Number(pe?.TaxableAmount || 0).toFixed(2)}
                                </Td>
                                ...
                                {pe.igst !== 0 && (
                                  <>
                                    ...
                                    <Td
                                      ...
                                      p={2}
                                    >
                                      {Number(pe?.igstRate || 0).toFixed(2)}
                                    </Td>
                                  </>
                                )}
                                ...
                                <Td
                                  ...
                                  p={2}
                                >
                                  {Number(pe?.GrandTotal || 0).toFixed(2)}
                                </Td>
                              </Tr>
                            );
                          })
                        ...
                        {pricingElements.length > 0 && (
                          <>
                            ...
                            <Tr>
                              <Td
                                colSpan={3} // ✅ Merges 3 columns for "Total"
                                border="1px"
                                borderColor="black"
                                p={2}
                                bg="skyblue"
                            ...
                            {/* ... other summary rows unchanged but add border="1px" borderColor="black" to each <Td> */}
                          </>
                        )}
                      </Tbody>
                    </Table>
